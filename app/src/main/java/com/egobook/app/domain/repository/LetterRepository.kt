...
interface LetterRepository {
    ...
    suspend fun reportArrivedLetter(letterId: Long, reportContent: ReportContent): Result<Unit>
    suspend fun fetchReceivedReplyById(replyId: Long): Result<ReceivedReply>
}